...
- **Retrieval-Augmented Generation (RAG)**: Utilização de um banco de dados vetorial para fornecer contexto técnico à IA a partir de um acervo de laudos anteriores e manuais de procedimento (POPs).
